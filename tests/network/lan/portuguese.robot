...
Factory default IPV4 settings are correct (bridge mode)
    ...
    Dynamic IP Address toggle title should be "Endereço IP Dinâmico (Automático)"
    Dynamic IP Address info text should be "Neste modo o seu AP receberá um endereço IP automaticamente ao servidor DHCP da sua rede local"
    Dynamic IP Address toggle should be visible
    
    Fixed IP Address / Fallback bridge IPv4 input title should be "Endereço de IP Fixo / Fallback"
    Fixed IP Address bridge IPv4 should be "10.0.0.1"
    Fixed IP Address bridge IPv4 input should be enabled

    Subnet Mask bridge IPv4 input title should be "Máscara de Sub-rede"    
    Subnet Mask bridge IPv4 should be "16"
    Subnet Mask bridge IPv4 input should be enabled

    Default Gateway bridge IPv4 input title should be "Gateway Padrão"    
    Default Gateway bridge IPv4 should be "10.0.255.254"
    Default Gateway bridge IPv4 input should be enabled
    
    LAN page save settings button text should be "SALVAR"
...
Factory default IPV6 settings are correct (bridge mode)
    ...
    IPv6 configuration type title should be "Tipo de Configuração"
    ...
    Link Local bridge IPv6 input should be "Desabilitado"
    ...
    IP address bridge IPv6 input title should be "Endereço IP"    
    IP address bridge IPv6 input should be enabled
    IP address bridge IPv6 input should be ""

    Prefix Size bridge IPv6 input title should be "Tamanho do Prefixo"    
    Prefix Size bridge IPv6 input should be enabled
    Prefix Size bridge IPv6 input should be ""
    
    Default Gateway bridge IPv6 input title should be "Gateway Padrão"
...
Factory default IPV4 settings are correct (router mode)
    ...
    Fixed IP Address router IPv4 input title should be "Endereço de IP Fixo"    
    Fixed IP Address router IPv4 should be "10.0.0.1"
    Fixed IP Address router IPv4 input should be enabled

    Subnet Mask router IPv4 input title should be "Máscara de Sub-rede"    
...
Factory default IPV6 settings are correct (router mode)
    ...
    Link Local router IPv6 input should be "Desabilitado"
    ...
    IP address router IPv6 input title should be "Endereço IP"
    IP address router IPv6 input should be enabled
    IP address router IPv6 input should be ""
    
    Prefix Size router IPv6 input title should be "Tamanho do Prefixo"
...
Four network lan configuration type are available: Desativado, Manual, Automático and Link-Local
    [Tags]    robot:continue-on-failure    smoke

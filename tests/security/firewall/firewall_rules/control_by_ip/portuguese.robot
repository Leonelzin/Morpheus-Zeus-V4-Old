...
Resource            ../../../../resources/pages/security/firewall_rules/firewall_rules.resource
...
Factory Default settings for control by ip are correct
    ...
    Create firewall rule in IP control

    Description input text of present in the table should be ""
    Description input text of present in the table should be enabled
    
    Enabled checkbox present in the table should be enabled

    Action select present in the table should be enabled
    Open Action selection dropdown menu present in the table
    Select Action present in the table "Liberar"

    Protocol select present in the table should be enabled
    Open Protocol selection dropdown menu present in the table
    Select Protocol present in the table "TCP/UDP"
...
Two Action present in the table are available: Release and Block
    [Tags]    smoke
    There should be "2" action present in the table available
    Action present in the table "Liberar" should be available
    Action present in the table "Bloquear" should be available
    [Teardown]    No operation

Three Protocol present in the table are available: TCP/UDP, TCP & UDP
    [Tags]    smoke
    There should be "3" protocol present in the table available
    Protocol present in the table "TCP/UDP" should be available
    Protocol present in the table "TCP" should be available
    Protocol present in the table "UDP" should be available
